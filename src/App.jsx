    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a href="https://www.webmotors.com.br/sedans " target="_blank" className="font-lexend bg-offwhite block px-10 py-3 w-fit rounded-3xl text-orange">Ver mais</a>
        </div>
        ...
        <div className="bg-green p-12">
          ...
          <a href="https://www.webmotors.com.br/suvs" target="_blank" className="font-lexend bg-offwhite block px-10 py-3 w-fit rounded-3xl text-green">Ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a href="https://www.webmotors.com.br/carros-de-luxo" target="_blank" className="font-lexend bg-offwhite block px-10 py-3 w-fit rounded-3xl text-darkgreen">Ver mais</a>
        </div>
      </section>
    </main>
  )
